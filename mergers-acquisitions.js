...
/**
 * Removes HTML tags from the provided text. Used to convert WordPress excerpts
 * into plain text without markup.
 * @param {string} html
 * @returns {string}
 */
...
exports.handler = async function handler() {
  const tagId = 39; // WordPress tag ID for mergers & acquisitions on Reinsurance News
  const perPage = 8;
